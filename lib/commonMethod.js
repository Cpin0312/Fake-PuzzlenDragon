class commonMethod
{
    ...
    hitDrop(draggedDrop,arryDrop)
    {
    	var thisDrop = draggedDrop;
    	let pointX = thisDrop.org_position_x - (thisDrop.width * (4/5) );
    	let pointXDistance = thisDrop.org_position_x + (thisDrop.width* (4/5) );
    	let pointY = thisDrop.org_position_y - (thisDrop.height* (4/5));
    	let pointYDistance = thisDrop.org_position_y + (thisDrop.height* (4/5));
